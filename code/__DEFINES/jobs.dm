...
#define DEPARTMENT_BITFLAG_FOREST (1<<11) //TIPOS EDIT CHANGE
#define DEPARTMENT_FOREST "Forest" //TIPOS EDIT CHANGE
...
DEFINE_BITFIELD(departments_bitflags, list(
	...
	"FOREST" = DEPARTMENT_BITFLAG_FOREST, //TIPOS EDIT CHANGE
))
